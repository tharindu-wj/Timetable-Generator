...
public class StudentGroups {
	...
	public StudentGroups(String string, int numberOfLectures, int i, ArrayList<Combination> combs, String subject, boolean lab, String dept) throws ClassNotFoundException, SQLException {
