...
//	}
    ...
    public void initializeTimeTable() throws ClassNotFoundException, SQLException {
        System.out.println("Enterd Enitialize TT");
        for (Iterator<ClassRoom> roomsIterator = rooms.iterator(); roomsIterator.hasNext();) {
            ...
            if (room.isLaboratory()) {
              ...
              //  System.out.println(practicalRooms.size() + "pr");
            } else {
                theoryRooms.add(room);
               // System.out.println(theoryRooms.size() + "th");
            }
        }
        for (Iterator<StudentGroups> studentGroupIterator = studentGroups.iterator(); studentGroupIterator.hasNext();) {
            ...
            System.out.println(studentGroup.getName() + "  " + studentGroup.isPractical());
            if (studentGroup.isPractical()) {
                practicalStudentGroups.add(studentGroup);
              //  System.out.println("prstd" + practicalStudentGroups.size());
            } else {
                theoryStudentGroups.add(studentGroup);
              //  System.out.println("thory  " + theoryStudentGroups.size());
            }
        }
        System.out.println("End of tt ini");
        rooms.clear();
        //studentGroups.clear();
    ...
    public void setTimeTable(ArrayList<StudentGroups> studentGroups2, ArrayList<ClassRoom> rooms2, String string) throws ClassNotFoundException, SQLException {
        // TODO Auto-generated method stub
        ...
        System.out.println("setTimetable middle");
        System.out.println(lecturesStack.size());
        while (!(lecturesStack.empty())) {
            ...
            if (string.equalsIgnoreCase("theory")) {
                System.out.println(lecture2.getSubject() + "  " + rooms2.toString());
                placeTheoryLecture(lecture2, rooms2);
                
            }
            if (string.equalsIgnoreCase("practical")) {
              System.out.println(lecture2.getSubject() + "  " + rooms2.isEmpty());
                placePracticalLecture(lecture2, rooms2);
                
            }
        }
        System.out.println("setTimetable End");
    }

    private void placePracticalLecture(Lecture lecture2, ArrayList<ClassRoom> rooms2) throws ClassNotFoundException, SQLException {
        // TODO Auto-generated method stub
        ...
        Collections.shuffle(rooms2);
         System.out.println("Place practical lec start");
        while (invalid) {
            
            room = getBestRoom(size, rooms2);
          //  System.out.println(DBConnection.getdept(room.getDepartment())+"                          ADSFS");
            String dd=DBConnection.getdept(room.getDepartment());
            System.out.println(  room.getDepartment());
             System.out.println("Place practical lec getBestRoom");
            if (dd.equalsIgnoreCase(dept)) {
                invalid = false;
                Collections.shuffle(rooms2);
            } else {
                Collections.shuffle(rooms2);
        ...
        System.out.println("Place practical lec middle");
    ...
    private void placeTheoryLecture(Lecture lecture, ArrayList<ClassRoom> rooms2) throws ClassNotFoundException, SQLException {
        // TODO Auto-generated method stub
        ...
        while (invalid) {
           ...
           //  System.out.println(DBConnection.getdept(room.getDepartment())+"                  AAAAA");
            String dd=DBConnection.getdept(room.getDepartment());
            System.out.println(dd+"  XX "+dept);
            System.out.println( dd.equalsIgnoreCase(dept));
        //     System.out.println("Place practical lec getBestRoom");
            if (dd.equalsIgnoreCase(dept)) {
